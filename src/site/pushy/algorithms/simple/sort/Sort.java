...
public class Sort {
    ...
    public static void insertSort() {
        ...
        System.out.println("Select site.pushy.algorithms.simple.sort result is " + Arrays.toString(arr));
    }
    ...
    public static void bubbleSort() {
        ...
        System.out.println("Bubble site.pushy.algorithms.simple.sort result is " + Arrays.toString(arr));
    }
